...
$$
where $\xi_\theta(t,x_t)$ is parametric function which aims at estimating the noise between $x_0$ and $x_t$. Using this parameterization yields
$$
\mathrm{KL}\left(q_{t-1|0,t}(\cdot|x_0,x_t)\middle\|p_{\theta,t-1|t}(\cdot|x_t)\right) =  \frac{\beta_t^2}{2\sigma^{2}_{t}\left(1-\bar{\alpha}_t\right)}\left\|\xi_t -  \xi_\theta(t,x_t)\right\|_2^2\eqsp.
$$
